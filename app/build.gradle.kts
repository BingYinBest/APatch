...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/BingYinBest/KernelPatch/releases/download/$kernelPatchVersion/kpimg-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/BingYinBest/KernelPatch/releases/download/$kernelPatchVersion/kptools-android",
...
tasks.register("downloadJailbreakKo") {
    doLast {
        ...
        jailbreakKmis.forEach { kmi ->
            val srcUrl =
                "https://github.com/BingYinBest/KernelPatch/releases/download/$kernelPatchVersion/${kmi}_kernelpatch.ko"
